...
<b><emoji id={ping2}>⏰</emoji> ᴜᴘᴛɪᴍᴇ :</b> <code>{uptime}</code></b>
<b><emoji id={ping3}>👑</emoji> ᴘᴇɴɢᴜᴀꜱᴀ :<a href=tg://user?id={client.me.id}>{client.me.first_name} {client.me.last_name or ''}</a></b>
"""
    else:
        _ping = f"""
<b>❏ ᴘɪᴡᴡ!! :</b> <code>{delta_ping} ms</code></b> 
<b>├ ᴜᴘᴛɪᴍᴇ :</b> <code>{uptime}</code></b>
<b>╰ ᴛᴜᴀɴᴋᴜ :<a href=tg://user?id={client.me.id}>{client.me.first_name} {client.me.last_name or ''}</a></b>
"""
